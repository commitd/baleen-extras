package com.tenode.baleen.abta.common.stopwords;
...
public class StopWordRemover {
	...
	private static final String[] DEFAULT_STOPWORDS = { "a", "about", "above", "across", "after", "afterwards",
			...
			"everything", "everywhere", "except", "few", "fifteen", "fifty", "fill", "find", "first", "five",
	 ...
	 *            the words (non-null)
	 */
	public StopWordRemover(String[] words) {
		stopWords = Arrays.asList(words).stream()
	...
	public String clean(String text) {
		// TODO: not very efficient, should create a regex in the constructor from all the stop
		// words and do it once here
		String clean = text;
		for (String s : stopWords) {
			clean = clean.replaceAll("\\w" + s + "\\w", "");
		}
		return clean;
	}
