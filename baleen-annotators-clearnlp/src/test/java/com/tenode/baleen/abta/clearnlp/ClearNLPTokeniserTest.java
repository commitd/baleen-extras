...
public class ClearNLPTokeniserTest extends AnnotatorTestBase {
	...
	public void beforeTest() throws UIMAException {
		...
		AnalysisEngineDescription desc = AnalysisEngineFactory.createEngineDescription(ClearNlpTokeniser.class,
				"lexica",
				tokensDesc);
	...
	public void test() throws Exception {
		...
		assertEquals("NN", tokens.get(3).getPartOfSpeech()); // 4th token of first sentence is a
