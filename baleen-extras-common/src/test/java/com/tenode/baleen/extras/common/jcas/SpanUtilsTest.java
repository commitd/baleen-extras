...
public class SpanUtilsTest {
	...
	public void testCopyEntity() {
		...
		final Entity copyEntity = SpanUtils.copyEntity(jCas, 10, 20, e);
	...
	public void testExistingEntityCollectionOfEntityIntInt() {
		...
		assertFalse(SpanUtils.existingEntity(entities, 6, 8));
		assertTrue(SpanUtils.existingEntity(entities, 11, 12));
	...
	public void testExistingEntityCollectionOfEntityIntIntClassOfQextendsEntity() {
		...
		assertFalse(SpanUtils.existingEntity(entities, 6, 8, Entity.class));
		assertTrue(SpanUtils.existingEntity(entities, 11, 12, Entity.class));

		assertFalse(SpanUtils.existingEntity(entities, 11, 12, Location.class));
		assertTrue(SpanUtils.existingEntity(entities, 11, 12, Person.class));
	...
	public void testOverlaps() {
		...
		assertTrue(SpanUtils.overlaps(a, b));
		assertTrue(SpanUtils.overlaps(b, a));

		assertFalse(SpanUtils.overlaps(a, c));
		assertFalse(SpanUtils.overlaps(c, a));
